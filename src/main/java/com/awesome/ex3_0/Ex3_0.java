...
public class Ex3_0 extends BaseExamplePeriod {
    ...
    public final void operation() {
        ObjectThatsSerialized o = deserialize(buf);
        o.changeMe();
        buf.clear();
        serialize(o, buf);
        buf.flip();
